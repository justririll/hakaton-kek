...
<template>
  <svg
    ...
    :class="['icon-svg', $props.class]"
  >
    <!-- activity / pulse -->
    <path v-if="name === 'activity'" d="M22 12h-4l-3 9L9 3l-3 9H2" />

    <!-- trending-up / dynamics -->
    <g v-else-if="name === 'trending-up'">
      <polyline points="23 6 13.5 15.5 8.5 10.5 1 18" />
      <polyline points="17 6 23 6 23 12" />
    </g>

    <!-- message-square / feedback -->
    <path v-else-if="name === 'message-square'" d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
    ...
    <!-- moon -->
    <path v-else-if="name === 'moon'" d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
